...
const (
	PricingService_GetRecommendedPrice_FullMethodName = "/pricing.v1.PricingService/GetRecommendedPrice"
)
...
type PricingServiceClient interface {
	GetRecommendedPrice(ctx context.Context, in *PriceRequest, opts ...grpc.CallOption) (*PriceResponse, error)
}
...
func (c *pricingServiceClient) GetRecommendedPrice(ctx context.Context, in *PriceRequest, opts ...grpc.CallOption) (*PriceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PriceResponse)
	err := c.cc.Invoke(ctx, PricingService_GetRecommendedPrice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PricingServiceServer interface {
	GetRecommendedPrice(context.Context, *PriceRequest) (*PriceResponse, error)
...
func (UnimplementedPricingServiceServer) GetRecommendedPrice(context.Context, *PriceRequest) (*PriceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRecommendedPrice not implemented")
}
...
func _PricingService_GetRecommendedPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PricingServiceServer).GetRecommendedPrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PricingService_GetRecommendedPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PricingServiceServer).GetRecommendedPrice(ctx, req.(*PriceRequest))
	}
...
var PricingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRecommendedPrice",
			Handler:    _PricingService_GetRecommendedPrice_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/pricing.proto",
}
